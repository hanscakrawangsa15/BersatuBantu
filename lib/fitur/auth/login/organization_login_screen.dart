...
class _OrganizationLoginScreenState extends State<OrganizationLoginScreen> {
  ...
  Future<void> _handleLogin() async {
    ...
    try {
      ...
      // Check if organization with this email exists in organization_verifications
      final verificationResponse = await supabase
          .from('organization_verifications')
          .select('id, status, org_legal_name')
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              'Selamat datang ${verificationResponse['org_legal_name']}!',
            ),
