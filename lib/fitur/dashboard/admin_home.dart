...
class _AdminHomeDashboardState extends State<AdminHomeDashboard> with AutomaticKeepAliveClientMixin {
  ...
  void initState() {
    super.initState();
    print('[AdminDashboard] initState - Admin profile: $ADMIN_USERNAME');
    _loadCampaigns();
  }

  @override
  void dispose() {
    print('[AdminDashboard] dispose');
    super.dispose();
  }
  ...
  void _onNavTap(int index) async {
    ...
    switch (index) {
      case 0:
        ...
        break;
      case 1:
        // Navigate to Berita screen (placeholder for add news)
        print('[AdminDashboard] Navigate to Berita');
        break;
      case 2:
        // Navigate to Admin Dashboard (Verifikasi Berkas)
        print('[AdminDashboard] Navigate to Verifikasi Berkas');
        ...
        // Always reset to Beranda after returning from verification
        if (mounted) {
          setState(() {
            _selectedIndex = 0;
          });
        ...
        break;
      case 3:
        // Navigate to Profil (Atur Profil) - Admin version
        print('[AdminDashboard] Navigate to Profil');
        await Navigator.push(
          context,
          MaterialPageRoute(
        ...
        // Always reset to Beranda after returning from profile
        if (mounted) {
          setState(() {
            _selectedIndex = 0;
          });
  ...
  Widget build(BuildContext context) {
    ...
    print('[AdminDashboard] build() - index=$_selectedIndex, username=$ADMIN_USERNAME');
